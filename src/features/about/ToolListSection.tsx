    ...
    <div className="max-w-4xl mx-auto rounded-3xl shadow-xl bg-white/95 dark:bg-gray-900/90 backdrop-blur p-8 sm:p-12">
      ...
      <ul className="grid grid-cols-1 sm:grid-cols-2 gap-6 text-lg text-gray-800 dark:text-gray-200">
        <li>
          ...
          <span className="ml-2 text-gray-600 dark:text-gray-200">– for routing, SSR, and probably your future job interview</span>
        </li>
        <li>
          ...
          <span className="ml-2 text-gray-600 dark:text-gray-200">– utility classes so good it feels like cheating</span>
        </li>
        <li>
          ...
          <span className="ml-2 text-gray-600 dark:text-gray-200">– pretty buttons without the 90-minute setup</span>
        </li>
        <li>
          ...
          <span className="ml-2 text-gray-600 dark:text-gray-200">– get login flows working before rage-quitting</span>
        </li>
        <li>
          ...
          <span className="ml-2 text-gray-600 dark:text-gray-200">– inspect your UI like a curious raccoon</span>
        </li>
        <li>
          ...
          <span className="ml-2 text-gray-600 dark:text-gray-200">– fake those APIs like a pro</span>
        </li>
      </ul>
    </div>
  </section>
